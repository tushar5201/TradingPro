...
public class MarketsFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        runnable = new Runnable() {
            ...
            public void run() {
                ...
                fetchStockPrices("^NSEI");
                fetchStockPrices("^NSEBANK");
                fetchStockPrices("^BSESN");
                fetchStockPrices("NIFTY_FIN_SERVICE.NS");
                fetchStockPrices("^INDIAVIX");
    ...
    private void fetchStockPrices(String stockSymbol) {
                ...
                try {
                    if (response.isSuccessful() && response.body() != null) {
                        ...
                        if (symbol.equals("^NSEI")) {
                            dataList.set(0, new IndicesModel(symbol, symbolFullName, stockPrice, stockPlusMinusPoints, stockPlusMinusPercentage, "https://s3-symbol-logo.tradingview.com/indices/nifty-50--600.png"));
                        } else if (symbol.equals("^NSEBANK")) {
                            dataList.set(1, new IndicesModel(symbol, symbolFullName, stockPrice, stockPlusMinusPoints, stockPlusMinusPercentage, "https://s3-symbol-logo.tradingview.com/sector/financial--600.png"));
                        } else if(symbol.equals("^BSESN")) {
                            dataList.set(2, new IndicesModel(symbol, symbolFullName, stockPrice, stockPlusMinusPoints, stockPlusMinusPercentage, "https://s3-symbol-logo.tradingview.com/indices/bse-sensex--600.png"));
                        } else if(symbol.equals("NIFTY_FIN_SERVICE.NS")) {
                            dataList.set(3, new IndicesModel(symbol, symbolFullName, stockPrice, stockPlusMinusPoints, stockPlusMinusPercentage, "https://s3-symbol-logo.tradingview.com/indices/finnifty--600.png"));
                        } else if(symbol.equals("^INDIAVIX")) {
                            dataList.set(4, new IndicesModel(symbol, symbolFullName, stockPrice, stockPlusMinusPoints, stockPlusMinusPercentage, "https://s3-symbol-logo.tradingview.com/indices/india-vix--600.png"));
                        }
